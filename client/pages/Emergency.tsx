  ...
  return (
    <div className="container py-10 space-y-8">
      ...
      <p className="text-muted-foreground">
        One-tap alert to nearest services. Your GPS coordinates are shared.
      </p>

      <div className="grid md:grid-cols-3 gap-6">
        <div className="rounded-2xl border p-6 bg-gradient-to-br from-red-500 to-rose-600 text-white shadow-lg">
          <div className="flex items-center gap-2 text-lg font-semibold">
            <Shield className="h-5 w-5" /> Police
          </div>
          <p className="text-sm/6 opacity-90 mt-1">
            Law & order, theft, assaults, public safety.
          </p>
          <Button
            onClick={() => withGPS("Police")}
            className="mt-4 w-full bg-white text-red-600 hover:bg-white/90"
          >
            Alert Police
          </Button>
        </div>
        <div className="rounded-2xl border p-6 bg-gradient-to-br from-amber-500 to-orange-600 text-white shadow-lg">
          <div className="flex items-center gap-2 text-lg font-semibold">
            <FlameKindling className="h-5 w-5" /> Fire
          </div>
          <p className="text-sm/6 opacity-90 mt-1">
            Fires, gas leaks, structural hazards.
          </p>
          <Button
            onClick={() => withGPS("Fire")}
            className="mt-4 w-full bg-white text-amber-700 hover:bg-white/90"
          >
            Alert Fire Dept
          </Button>
        </div>
        <div className="rounded-2xl border p-6 bg-gradient-to-br from-emerald-600 to-green-700 text-white shadow-lg">
          <div className="flex items-center gap-2 text-lg font-semibold">
            <Ambulance className="h-5 w-5" /> Medical
          </div>
          <p className="text-sm/6 opacity-90 mt-1">
            Accidents, injuries, medical emergencies.
          </p>
          <Button
            onClick={() => withGPS("Ambulance")}
      ...
      <div className="rounded-2xl border bg-card p-6 shadow-sm">
        <div className="flex items-center gap-2 text-lg font-semibold">
          <Siren className="h-5 w-5 text-primary" /> SOS Broadcast
        </div>
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            href={`https://wa.me/?text=${encodeURIComponent("Emergency! Need help at " + (coords || "[tap a service to capture GPS]"))}`}
          >
            WhatsApp
          </a>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            href={`https://twitter.com/intent/tweet?text=${encodeURIComponent("Emergency! Need help at " + (coords || "[tap a service to capture GPS]"))}`}
          >
            Twitter/X
          </a>
        </div>
